            ...
            if (location.pathname == '/index.html') {
                ...
                for (let film of response) {
                    if (film.condizione == "sala") {
                        ...
                        result += '<div class="col-md"><div class="text-center"><a href="#"><img src="' + film.img + '"alt="" width="70%" class="content"></a><div class="mt-4"><a href="#" class="titolo-film">' + film.nome + '</a><p class="genere">' + film.genere + '</p></div></div></div>'
                    }
                    counter++;
                }
                result += '</div>';
    ...
    async function findLastFilms() {
        ...
        for (let prenotazione of infoOspite.prenotazioni) {
            if (c < 3) {
                ...
                result += '<div class="col-lg my-3"><div class="card text-center"><img src="' + film.img + '" class="card-img-top"/><div class="card-body"><h5 class="card-title">' + film.nome + '</h5><p class="card-text">' + film.descrizione + '</p>'
                result += giveValutazione(prenotazione.valutazione);
                result += '</div></div></div>'
            }
            c++;
    ...
    if (location.pathname == '/classifica.html') {
        ...
        function inserimentoUtentiClassifica(accountMap) {
            ...
            for (let [key, value] of accountMap) {
                ...
                result += '<img src="img/avatar/' + utente.img + '" alt=""style="width: 45px; height: 45px" class="rounded-circle" /><div class="ms-3"><p class="fw-bold mb-1">' + utente.username + '</p></div></div></td>'
                result += '<td><p class="fw-normal mb-1">' + value + '</p></td><td><p>' + utente.dataIscrizione + '</p></td><td><button type="button" class="btn btn-link btn-sm btn-rounded">Vedi</button></td></tr>'
                counter++;
            }
